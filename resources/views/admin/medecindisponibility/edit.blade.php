...
@section('content')
    ...
    {!! Form::model($available, ['method' =>'PATCH', 'action' => ['MedecinDisponibilityController@update', $available->id]]) !!}
    ...
    <div class = "form-group">
        ...
        {!! Form::open(['method' => 'DELETE', 'action' => ['MedecinDisponibilityController@destroy', $available->id], 'class'=>'btn-group mr-2']) !!}
