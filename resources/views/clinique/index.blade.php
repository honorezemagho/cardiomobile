    ...
    <div class="display-table">
        <div class="display-table-cell">
            <div class="container  pt-50 pb-5">
                ...
                {!! Form::open(['method' =>'POST', 'action' => 'ReceivingCliniquedataController@store', 'class' => 'bg-theme-colored p-30 text-white']) !!}
                        ...
                        <table class = "table">
                            ...
                            @foreach( $records as $available)
                                <tr>
                                    ...
                                    <td heure = 'heure'>{{ \Carbon\Carbon::parseFromLocale($available->datetime, $locale)->toTimeString()}}</td>
