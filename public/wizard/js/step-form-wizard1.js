...
(function($) {
    ...
    var defaults = {
        duration: 1000,
        transition: 'slide',
        linkNav: false, // true, false, prev
        showNav: false, // true = top, false , right, bottom, left
        showNavNumbers: true,
        showButtons: true,
        showLegend: true,
        nextBtn: $('<a class="next-btn sf-right sf-btn" href="#">SUIVANT</a>'),
        prevBtn: $('<a class="prev-btn sf-left sf-btn" href="#">RETOUR</a>'),
        finishBtn: $('<input class="finish-btn sf-right sf-btn" type="submit" value="COMMANDER" id="search"/>'),
