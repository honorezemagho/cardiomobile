...
b);d.preventDefault()})};e.prototype.addClickFinish=function(a){var c=this;d(c.wizard).off("click",".finish-btn");d(c.wizard).on("click",".finish-btn",function(d,b){"undefined"!==typeof a&&!0!==a||c.finish(b);d.preventDefault()})};e.prototype.addSpinner=function(a,c){!1===c?("Suivant"==a&&this.nextLabel(this.labels.next),"précédent"==a&&this.prevLabel(this.labels.prev),"Envoyer"==a&&this.finishLabel(this.labels.finish),isNaN(a)||this.navLabel(a,this.labels[a])):("next"==a&&(this.labels.next=this.nextLabel(),
