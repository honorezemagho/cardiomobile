...
class PaymentController extends Controller
{
    ...
    public function now(Request $request)
    {
        ...
        $merchant_uid = 'AtZO3EtkbUXsRkwVGnGKPjqNNaA2';
        $merchant_public_key = 'pk_live_7PGOQNHIjc5L1P2Y';
        $merchant_secret = 'sk_live_As9RnDGSFGWh7wNsiVkNaAcbg6RtQMUNbLlBhmBKKkK8';
